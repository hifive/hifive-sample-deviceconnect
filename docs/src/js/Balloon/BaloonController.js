$(function() {
    ...
    var balloonController = {
        ...
        '{document} pump' : function(context, $el) {
            ...
            var sizeRatio = this._air/this._capacity;
            this.trigger("bright", {'pumpPercen' : sizeRatio});
        ...
        _drawLine : function() {
            ...
            var stringSvg = $("#stringSvg").offset();
            var tiedX = stringSvg.left - (balloonOffset.left + this._$balloon.outerWidth() * 0.5);
