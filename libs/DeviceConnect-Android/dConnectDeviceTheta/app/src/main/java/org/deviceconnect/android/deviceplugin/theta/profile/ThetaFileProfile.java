...
public class ThetaFileProfile extends FileProfile {
    ...
    private final DConnectApi mGetReceiveApi = new GetApi() {
        ...
        public boolean onRequest(final Intent request, final Intent response) {
            ...
            final Integer fileType = getFileType(request);
            ...
            if (components.length == 2) {
                ...
                getFileManager().checkWritePermission(new FileManager.CheckPermissionCallback() {
                    ...
                    public void onSuccess() {
                        ...
                        mClient.fetchObject(serviceId, fileName, fileType, new ThetaDeviceClient.DefaultListener() {
     ...
     */
    public static Integer getFileType(final Intent request) {
        return parseInteger(request, PARAM_FILE_TYPE);
    }
}
