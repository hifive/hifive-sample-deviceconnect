...
public class ThetaDeviceClient {
    ...
    public void fetchObject(final String id, final String fileName, final Integer fileType,
                            final ResponseListener listener) {
        mExecutor.execute(new Runnable() {
            @Override
            public void run() {
